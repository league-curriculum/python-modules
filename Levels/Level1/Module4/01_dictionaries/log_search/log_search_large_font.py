...
class Log(tk.Tk):
    def __init__(self):
        ...
        self.entries = dict()
                ...
                # Define a font
        button_font = Font(family="Helvetica", size=24)

        self.button_add = tk.Button(self, text='Add', font=button_font)
        self.button_search = tk.Button(self, text='Search', font=button_font)
        self.button_view = tk.Button(self, text='View', font=button_font)
        self.button_remove = tk.Button(self, text='Remove', font=button_font)
