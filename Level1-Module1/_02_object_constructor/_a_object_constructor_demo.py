...
# are created in a special function called the constructor:
#   def __init__(self):
...
obj_1 = TestConstructor()   # Prints the message in the constructor
obj_2 = TestConstructor()   # Prints the message in the constructor
