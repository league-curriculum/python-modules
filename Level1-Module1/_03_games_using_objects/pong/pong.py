...
def setup():
    ...
    # 3. Initialize your ball variable to a new Ball object
    # Make sure to check the Ball constructor!

    # 4. Make a global paddle variable.

    # 5. Initialize your paddle variable to a new Paddle object
    # Make sure to check the Paddle constructor!
